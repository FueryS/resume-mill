 ...
 * Sub-category grouping uses Approach 3 (thin red dashed left border line) combined with Approach 1 (Python-style indentation).
...
export default function Timeline_Page({ data, pageData, showWatermark = true, showFullUrls = false }) {
  ...
  const renderUngroupedProj = () => (
    ungroupedProj.map((proj, idx) => (
      (proj.name || proj.description) && (
        <div key={proj.id || idx} className={styles.timelineItem}>
          <div className={styles.timelineDot}></div>
          <div className={styles.itemBlock}>
            <div className={styles.itemHeader}>
  ...
  const renderUngroupedAch = () => (
    ungroupedAch.map((ach, idx) => (
      (ach.title || ach.description) && (
        <div key={ach.id || idx} className={styles.timelineItem}>
          <div className={styles.timelineDot}></div>
          <div className={styles.itemBlock}>
            <div className={styles.itemHeader}>
              <div>
  ...
  return (
    <div className={`${styles.resumePage} ${styles.timeline}`}>
      ...
      {showHeader && (
        personal.pfp ? (
          <div className={styles.modernHeaderFlex}>
            ...
            <div className={styles.modernPfpWrapper} style={{ borderColor: 'var(--primary, #dc2626)' }}>
      ...
      {showHeader && personal.summary && (
        <div className={styles.sectionBlock}>
          <div className={styles.secTitleWithIcon}>
            <span className={styles.secIcon}><ExperienceIcon /></span>
      ...
      {hasProjects && (
        <div className={styles.sectionBlock}>
          <div className={styles.secTitleWithIcon}>
            <span className={styles.secIcon}><ProjectIcon /></span>
      ...
      {hasEducation && (
        <div className={styles.sectionBlock}>
          <div className={styles.secTitleWithIcon}>
            <span className={styles.secIcon}><EducationIcon /></span>
      ...
      {hasSkills && (
        <div className={styles.sectionBlock}>
          <div className={styles.secTitleWithIcon}>
            <span className={styles.secIcon}><SkillsIcon /></span>
      ...
      {hasLanguages && (
        <div className={styles.sectionBlock}>
          <div className={styles.secTitleWithIcon}>
            <span className={styles.secIcon}><LanguageIcon /></span>
            ...
            {languages.map((lang, idx) => (
              <div key={lang.id || idx} className={styles.langRow}>
                ...
                <div className={styles.progressBarBg}>
                  <div className={styles.progressBarFill} style={{ width: `${(lang.level || 5) * 20}%`, backgroundColor: '#dc2626' }}></div>
                </div>
              </div>
            ))}
          </div>
      ...
      {hasCertifications && (
        <div className={styles.sectionBlock}>
          <div className={styles.secTitleWithIcon}>
            <span className={styles.secIcon}><CertificationIcon /></span>
